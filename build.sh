...
export IRODS_PYTHON_RULE_ENGINE_VERSION=${IRODS_PYTHON_RULE_ENGINE_VERSION-4.3.5.0}
export IRODS_RESOURCE_PLUGIN_S3_VERSION=${IRODS_RESOURCE_PLUGIN_S3_VERSION-4.3.5.0}
...
docker build \
    ...
    --build-arg IRODS_RESOURCE_PLUGIN_S3_VERSION=${IRODS_RESOURCE_PLUGIN_S3_VERSION} \
    --target main \
    docker
